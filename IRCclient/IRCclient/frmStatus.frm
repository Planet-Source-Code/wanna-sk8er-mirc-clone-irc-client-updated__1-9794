...
frmMain.StatusBar.Panels(1).Bevel = sbrInset
End Sub
...
frmMain.StatusBar.Panels(1).Bevel = sbrRaised
End Sub
...
Private Sub rtfStatus_Change()
rtfStatus.SelStart = Len(rtfStatus.Text)
End Sub

Private Sub rtfStatus_Click()
    'Clears the Clipboard to put text on it
    Clipboard.Clear
    'Sets the Text from rtfText onto the Clipboard
    Clipboard.SetText rtfStatus.SelText
